// lib/ingredient-data.ts
//
// Static ingredient copy shared between the client detail page
// (app/ingredients/[slug]/page.tsx) and its server layout.tsx, which
// reads this data in generateMetadata() to build per-ingredient SEO tags.
...
export const INGREDIENT_DATA: Record<string, IngredientInfo> = {
  "aloe-vera": {
    label: "Aloe Vera",
    emoji: "🌿",
...
export function getIngredientLabel(slug: string) {
