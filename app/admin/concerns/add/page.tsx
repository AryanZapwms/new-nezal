...
export default function AddConcernPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage("success:Concern created successfully!")
      setTimeout(() => router.push("/admin/concerns"), 1200)
    } catch (err: any) {
      setMessage(err.message || "error:Error creating concern.")
    ...
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Add concern</h1>
            <p className="text-sm text-gray-500 mt-0.5">Create a new shop-by-concern landing page.</p>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input value={slug} onChange={(e) => setSlug(e.target.value)} placeholder="acne-oil-control" required className="font-mono" />
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Longer paragraph for the concern page"
              />
            </div>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
              ...
              <p className="text-xs text-gray-400 -mt-2 mb-3">Search and add products that address this concern.</p>
