...
import { ArrowLeft, X, Zap, Search, Package, CalendarClock, CheckCircle2, AlertCircle } from "lucide-react"
...
export default function AddFlashSalePage() {
  ...
  // Live preview of the discounted price for a selected product
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage("success:Flash sale created successfully!")
    ...
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Create flash sale</h1>
            <p className="text-sm text-gray-500 mt-0.5">Set a discount window and pick which products it applies to.</p>
          </div>
        </div>
