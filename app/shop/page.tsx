...
interface Product {
  ...
  // ── Fields the redesigned ProductCard can display — all optional so
  //    nothing breaks if a given product doc doesn't have them yet ──
  badges?: ProductBadge[];
...
type SortOption = "featured" | "price_asc" | "price_desc" | "name_asc" | "newest";
...
function ShopContent() {
  ...
  const [sortBy, setSortBy] = useState<SortOption>("featured");   // was "newest"
